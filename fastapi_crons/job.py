...
class CronJob:
    def __init__(self, func: Callable, expr: str, name: str | None = None, tags: list[str] | None = None) -> None:
        self.func = func
        self.expr = expr
...
def cron_job(expr: str, *, name: str | None = None, tags: list[str] | None = None) -> Callable:
